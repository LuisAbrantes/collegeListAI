...
export function Profile({ currentProfile }: ProfileProps) {
    ...
    const isDomestic = useMemo(() => {
        return ['US_CITIZEN', 'PERMANENT_RESIDENT', 'DACA'].includes(
    ...
    const inputClass =
        'w-full px-4 py-3 rounded-lg bg-zinc-900 border border-white/10 text-white focus:outline-none focus:border-blue-500/50 focus:ring-1 focus:ring-blue-500/50 transition-colors';
    const selectClass =
        'w-full px-4 py-3 rounded-lg bg-zinc-900 border border-white/10 text-white focus:outline-none focus:border-blue-500/50 focus:ring-1 focus:ring-blue-500/50 transition-colors appearance-none cursor-pointer';
            ...
            <div className="max-w-3xl mx-auto">
                <header className="mb-12">
                    ...
                    <p className="text-zinc-400">
                        Manage your profile and preferences for personalized
                        recommendations.
                    </p>
                </header>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-2 md:col-span-2">
                                ...
                                <p className={helperClass}>
                                    Your name for personalized greetings (never
                                    shared with AI).
                                </p>
                            </div>
                            ...
                            <div className="space-y-2">
                                ...
                                <select
                                    ...
                                    onChange={e =>
                                        setFormData(prev => ({
                                            ...prev,
                                            citizenshipStatus: e.target
                                                .value as CitizenshipStatus
                                        }))
                                    }
                                ...
                                <p className={helperClass}>
                                    Determines financial aid eligibility and
                            ...
                            <div className="space-y-2">
                                ...
                                <p className={helperClass}>
                                    {isDomestic
                                        ...
                                        : 'Used to check Need-Blind policies.'}
                                </p>
                            </div>
                            ...
                            {isDomestic && (
                                <div className="space-y-2">
                                    ...
                                    <p className={helperClass}>
                                        For in-state tuition calculations.
                                    </p>
                                </div>
                            )}
                                ...
                                formData.citizenshipStatus ===
                                    ...
                                    <>
                                        <div className="space-y-2">
                                            ...
                                            <p className={helperClass}>
                                                Select the English proficiency
                                                test you took.
                                            </p>
                                        </div>
                                        ...
                                        {formData.englishTestType && (
                                            <div className="space-y-2">
                                                ...
                                                <input
                                                    ...
                                                    step="1"
                                                    value={
                                                        formData.englishProficiencyScore ||
                                                        ''
                                                    }
                                                    onChange={e =>
                                                        setFormData(prev => ({
                                                ...
                                                <p className={helperClass}>
                                                    ...
                                                    {formData.englishTestType ===
                                                        'IELTS' &&
                                                        'IELTS band score (0-9, whole numbers).'}
                                                </p>
                                            </div>
                                        )}
                                    </>
                    ...
                    <section className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="space-y-2">
                                ...
                                />
                                <p className={helperClass}>
                                    Helps find programs with strong reputation
                                    in your field.
                                </p>
                            </div>
                            ...
                            <div className="space-y-2">
                                ...
                                />
                                <p className={helperClass}>
                                    Composite ACT score (1-36).
                                </p>
                            </div>

                            <div className="space-y-2">
                                <label
                                    htmlFor="apClassCount"
                                    className={labelClass}
                                >
                                ...
                                />
                                <p className={helperClass}>
                                    Total number of AP classes taken.
                                </p>
                            </div>
                            ...
                            {(formData.apClassCount ?? 0) > 0 && (
                                <div className="space-y-2 md:col-span-2">
                                    ...
                                    <input
                                        ...
                                        type="text"
                                        value={
                                            formData.apClasses?.join(', ') || ''
                                        }
                                        onChange={e =>
                                            setFormData(prev => ({
                                                ...prev,
                                                apClasses: e.target.value
                                                    .split(',')
                                                    .map(s => s.trim())
                                                    .filter(Boolean)
                                            }))
                                    ...
                                    />
                                    <p className={helperClass}>
                                        Enter AP subjects, comma-separated.
                                    </p>
                                </div>
                            )}
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="space-y-2">
                                ...
                                >
                                    ...
                                    <option value="JOB_PLACEMENT">
                                        💼 Immediate Job Placement (Big Tech,
                                        Finance)
                                    </option>
                                ...
                                <p className={helperClass}>
                                    Helps prioritize schools with matching
                                    career outcomes.
                                </p>
                            </div>
                            ...
                            <div className="space-y-4 md:col-span-2">
                                <div className="flex items-center gap-4 p-4 bg-zinc-900/50 rounded-lg border border-white/5">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <p className={helperClass}>
                                            Seeking athletic recruitment / NCAA
                                            programs
                                        </p>
                                    </div>
                                    <input
                                        ...
                                        type="checkbox"
                                        checked={
                                            formData.isStudentAthlete || false
                                        }
                                        onChange={e =>
                                            setFormData(prev => ({
                                                ...prev,
                                ...
                                <div className="flex items-center gap-4 p-4 bg-zinc-900/50 rounded-lg border border-white/5">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <p className={helperClass}>
                                            Family member attended a university
                                        </p>
                                    </div>
                                    <input
                                        id="hasLegacy"
                                        type="checkbox"
                                        checked={
                                            formData.hasLegacyStatus || false
                                        }
                                        onChange={e =>
                                            setFormData(prev => ({
                                                ...prev,
                                ...
                                {formData.hasLegacyStatus && (
                                    <div className="space-y-2 pl-9">
                                        ...
                                        <input
                                            ...
                                            type="text"
                                            value={
                                                formData.legacyUniversities?.join(
                                                    ', '
                                                ) || ''
                                            }
                                            onChange={e =>
                                        ...
                                        />
                                        <p className={helperClass}>
                                            Enter universities where you have
                                            legacy connections.
                                        </p>
                                    </div>
                                )}
