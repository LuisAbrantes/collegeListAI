    ...
    const features = [
        {
            ...
            description:
                'Get personalized college recommendations based on your GPA, test scores, and preferences.'
        },
        {
            icon: Target,
            title: 'Reach/Target/Safety',
            description:
                'Each school is labeled based on your admission probability.'
        },
        {
            icon: Shield,
            title: 'Financial Aid Insights',
            description:
                'Discover need-blind policies, merit scholarships, and financial aid opportunities.'
        },
        {
            icon: ListChecks,
            title: 'Build Your List',
            description:
                'Save schools to your personal college list and track your applications.'
        }
    ];
            ...
            <div className="max-w-4xl mx-auto">
                ...
                >
                    <div className="flex items-center justify-center gap-3 mb-4">
                        ...
                        <h1 className="text-3xl font-bold text-zinc-100">
                            Welcome to College List AI
                        </h1>
                    </div>
                    <p className="text-zinc-400 max-w-xl mx-auto">
                        Your AI-powered personalized college list maker. Build a
                        strategic list, get personalized recommendations.
                    </p>
                </motion.div>
                ...
                >
                    ...
                    <p className="text-sm text-zinc-400 leading-relaxed mb-4">
                        College List AI helps you build a strategic college list
                        tailored to your academic profile. Simply chat with our
                        AI advisor to get personalized recommendations based on
                        your GPA, test scores, intended major, and financial
                        situation.
                    </p>
                    <p className="text-sm text-zinc-400 leading-relaxed">
                        Our system categorizes schools into{' '}
                        <span className="text-zinc-200">Reach</span>{' '}
                        (competitive admits),
                        <span className="text-zinc-200"> Target</span> (good
                        match), and{' '}
                        <span className="text-zinc-200">Safety</span> (likely
                        admits) to help you create a balanced application
                        strategy. You can save schools to your personal list and
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-10">
                    ...
                    >
                        ...
                        <p className="text-zinc-500 text-sm">
                            Ask for recommendations, explore schools, or get
                            advice.
                        </p>
                    </motion.button>
                    ...
                    <motion.div
                        ...
                        animate={{ opacity: 1, x: 0 }}
                    >
                        <Link to="/app/my-list" className="block no-underline">
                            <div className="glass-card p-6 hover:bg-zinc-800/50 transition-colors">
                                ...
                                <p className="text-zinc-500 text-sm">
                                    View and manage your saved schools.
                                </p>
                            </div>
                        </Link>
                    </motion.div>
