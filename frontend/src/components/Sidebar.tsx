        ...
        <aside className="w-64 h-screen flex flex-col bg-zinc-950 border-r border-white/10 shrink-0">
            ...
            {isHome && (
                <div className="flex-1 overflow-y-auto px-3 mt-4">
                    <p className="text-xs text-zinc-600 uppercase tracking-wider px-3 mb-2">
                        Recent Chats
                    </p>
                                ...
                                >
                                    ...
                                    >
                                        <div className="flex items-start gap-2">
                                            <MessageSquare
                                                size={14}
                                                className={`mt-0.5 flex-shrink-0 ${threadId === thread.id ? 'text-white' : 'text-zinc-500'}`}
                                            />
                                            <div className="flex-1 min-w-0">
                                                <p
                                                    className={`text-xs truncate m-0 ${threadId === thread.id ? 'text-white' : 'text-zinc-300'}`}
                                                >
                                                    {thread.title ||
                                                        'New conversation'}
                                                </p>
                    ...
                    {threads.length > 0 && (
                        <p className="text-[10px] text-zinc-600 text-center px-3 mt-3">
                            {threads.length}/5 conversations
                        </p>
                    )}
                </div>
            )}
